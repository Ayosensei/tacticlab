  ...
  return (
    <div className="flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-2 mx-auto pt-20">
      ...
      <form
        ...
        action={signUp}
      >
        <h1 className="text-2xl font-black mb-2 text-emerald-500 uppercase tracking-widest text-center">Create Account</h1>
        ...
        <div className="flex flex-col gap-2 mt-2 text-center text-[11px] font-medium text-muted-foreground uppercase tracking-widest">
           ...
           <Link href="/login" className="font-black text-foreground hover:text-emerald-400 underline transition-colors">
             Log In
           </Link>
        </div>
      </form>
