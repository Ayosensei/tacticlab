...
export const FORMATIONS = [
  ...
  },
  {
    ...
    players: [
      ...
      { id: "3", role: "Central Defender", duty: "Defend", slot: "LCB", ...getGridSlot("LCB") },
      { id: "4", role: "Central Defender", duty: "Defend", slot: "RCB", ...getGridSlot("RCB") },
      { id: "5", role: "Full Back", duty: "Support", slot: "RB", ...getGridSlot("RB") },
      { id: "6", role: "Wide Midfielder", duty: "Support", slot: "LM", ...getGridSlot("LM") },
      { id: "7", role: "Central Midfielder", duty: "Defend", slot: "LCM", ...getGridSlot("LCM") },
      { id: "8", role: "Box To Box Midfielder", duty: "Support", slot: "RCM", ...getGridSlot("RCM") },
      { id: "9", role: "Winger", duty: "Attack", slot: "RM", ...getGridSlot("RM") },
      { id: "10", role: "Advanced Forward", duty: "Attack", slot: "LST", ...getGridSlot("LST") },
      { id: "11", role: "Target Forward", duty: "Support", slot: "RST", ...getGridSlot("RST") },
    ],
  },
  {
    ...
    players: [
      ...
      { id: "4", role: "Central Defender", duty: "Defend", slot: "RCB", ...getGridSlot("RCB") },
      { id: "5", role: "Full Back", duty: "Support", slot: "RB", ...getGridSlot("RB") },
      { id: "6", role: "Central Midfielder", duty: "Defend", slot: "LCM", ...getGridSlot("LCM") },
      { id: "7", role: "Central Midfielder", duty: "Support", slot: "RCM", ...getGridSlot("RCM") },
      { id: "8", role: "Winger", duty: "Attack", slot: "LW", ...getGridSlot("LW") },
      { id: "9", role: "Winger", duty: "Attack", slot: "RW", ...getGridSlot("RW") },
      { id: "10", role: "Advanced Forward", duty: "Attack", slot: "LST", ...getGridSlot("LST") },
      { id: "11", role: "Advanced Forward", duty: "Attack", slot: "RST", ...getGridSlot("RST") },
    ],
  },
  {
    id: "4-1-4-1 DM WIDE",
    ...
    players: [
      ...
      { id: "4", role: "Central Defender", duty: "Defend", slot: "RCB", ...getGridSlot("RCB") },
      { id: "5", role: "Full Back", duty: "Support", slot: "RB", ...getGridSlot("RB") },
      { id: "6", role: "Defensive Midfielder", duty: "Defend", slot: "DM", ...getGridSlot("DM") },
      { id: "7", role: "Wide Midfielder", duty: "Support", slot: "LM", ...getGridSlot("LM") },
      { id: "8", role: "Central Midfielder", duty: "Support", slot: "LCM", ...getGridSlot("LCM") },
      { id: "9", role: "Central Midfielder", duty: "Attack", slot: "RCM", ...getGridSlot("RCM") },
      { id: "10", role: "Winger", duty: "Attack", slot: "RM", ...getGridSlot("RM") },
      { id: "11", role: "Advanced Forward", duty: "Attack", slot: "ST", ...getGridSlot("ST") },
    ],
  },
  {
    ...
    players: [
      { id: "1", role: "Goalkeeper", duty: "Defend", slot: "GK", ...getGridSlot("GK") },
      { id: "2", role: "Wing Back", duty: "Support", slot: "LB", ...getGridSlot("LB") },
      { id: "3", role: "Central Defender", duty: "Defend", slot: "LCB", ...getGridSlot("LCB") },
      { id: "4", role: "Central Defender", duty: "Defend", slot: "RCB", ...getGridSlot("RCB") },
      { id: "5", role: "Wing Back", duty: "Support", slot: "RB", ...getGridSlot("RB") },
      { id: "6", role: "Defensive Midfielder", duty: "Defend", slot: "DM", ...getGridSlot("DM") },
      { id: "7", role: "Carrilero", duty: "Support", slot: "LCM", ...getGridSlot("LCM") },
      { id: "8", role: "Mezzala", duty: "Support", slot: "RCM", ...getGridSlot("RCM") },
      { id: "9", role: "Attacking Midfielder", duty: "Support", slot: "AM", ...getGridSlot("AM") },
      { id: "10", role: "Advanced Forward", duty: "Attack", slot: "LST", ...getGridSlot("LST") },
      { id: "11", role: "Advanced Forward", duty: "Attack", slot: "RST", ...getGridSlot("RST") },
    ],
  },
  {
    ...
    players: [
      ...
      { id: "4", role: "Central Defender", duty: "Defend", slot: "RCB", ...getGridSlot("RCB") },
      { id: "5", role: "Wing Back", duty: "Support", slot: "LWB", ...getGridSlot("LWB") },
      { id: "6", role: "Wing Back", duty: "Support", slot: "RWB", ...getGridSlot("RWB") },
      { id: "7", role: "Central Midfielder", duty: "Defend", slot: "LCM", ...getGridSlot("LCM") },
      { id: "8", role: "Box To Box Midfielder", duty: "Support", slot: "RCM", ...getGridSlot("RCM") },
      { id: "9", role: "Inside Forward", duty: "Attack", slot: "LW", ...getGridSlot("LW") },
      { id: "10", role: "Inside Forward", duty: "Attack", slot: "RW", ...getGridSlot("RW") },
      { id: "11", role: "Advanced Forward", duty: "Attack", slot: "ST", ...getGridSlot("ST") },
    ],
  },
  {
    ...
    players: [
      ...
      { id: "5", role: "Wing Back", duty: "Support", slot: "LWB", ...getGridSlot("LWB") },
      { id: "6", role: "Wing Back", duty: "Support", slot: "RWB", ...getGridSlot("RWB") },
      { id: "7", role: "Defensive Midfielder", duty: "Defend", slot: "DM", ...getGridSlot("DM") },
      { id: "8", role: "Central Midfielder", duty: "Support", slot: "LCM", ...getGridSlot("LCM") },
      { id: "9", role: "Mezzala", duty: "Attack", slot: "RCM", ...getGridSlot("RCM") },
      { id: "10", role: "Advanced Forward", duty: "Attack", slot: "LST", ...getGridSlot("LST") },
      { id: "11", role: "Target Forward", duty: "Support", slot: "RST", ...getGridSlot("RST") },
    ],
  }
